...
The Members Register is used for storing data of Committee or Board members. This includes contact information, type of security access for the member, history of roles and current role plus a sectuion for notes and Tags. [Process PA](https://processpa.com/){: target="_blank"}.
